...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'staff_advisor') {
    header("Location: login.php");
    exit();
}
$department = $_SESSION['department'];

$sql = "SELECT COUNT(a.id) as count FROM applications a JOIN users u ON a.student_id = u.id WHERE u.department = ? AND a.status = 'Pending Staff Advisor'";
...
<head>
    ...
    <title>Staff Advisor Dashboard</title>
...
<div class="main-layout">
    <aside class="sidebar">
        <div class="sidebar-header"><h3>Staff Advisor Portal</h3></div>
        <nav class="sidebar-nav">
            <ul>
                <li><a href="staff_advisor_dashboard.php" class="active"><i class="fa-solid fa-table-columns"></i> Dashboard</a></li>
            </ul>
        </nav>
    </aside>
    <div class="main-content">
        ...
        <main class="content-area">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-icon" style="background-color: #fef9c3;"><i class="fa-solid fa-inbox" style="color: #a16207;"></i></div>
                    <div class="stat-info">
                        <span class="stat-number"><?php echo $pending_count; ?></span>
                        <span class="stat-label">Applications Awaiting Your Review</span>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT a.id, a.company_name, a.submitted_at, u.full_name 
                                ...
                                WHERE u.department = ? AND a.status = 'Pending Staff Advisor'
                        ...
                        ?>
                        <tr><td colspan="4" style="text-align:center;">No applications are currently awaiting your review.</td></tr>
