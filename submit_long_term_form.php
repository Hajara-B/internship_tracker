...
<head>
    ...
    <title>Long-Term Internship Application</title>
    ...
    <style>
        ...
        .form-group { margin-bottom: 15px; position: relative; } /* Added for error messages */
            ...
            <div class="form-container">
                <div class="card">
                    <div class="form-header">
                        <h2>Application for Long-Term Internship</h2>
                    ...
                    <form id="applicationForm" action="handle_application.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="internship_type" value="long_term">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="stipend" placeholder="0 or min 10000" required>
                            ...
                            <div class="form-group"><label>Batch</label><input type="text" name="batch" placeholder="e.g., 2021-2025" required></div>
                            <div class="form-group"><label>Semester</label><input type="number" name="semester" value="7" readonly></div>
                        ...
                        <div class="form-grid checkbox-group">
                            ...
                            <div class="form-group full-width"><label><input type="checkbox" name="doc_cgpa_cert" value="1" required> Certificate mentioning the CGPA</label></div>
                            ...
                            <div class="form-group full-width"><label><input type="checkbox" name="doc_team_consent" value="1"> Letter of consent from fellow project team members (if applicable)</label></div>
                        </div>
...
<div id="undertakingModal" class="modal">
    <div class="modal-content">
        ...
        <h3>Undertaking for Long-Term Internship</h3>
        ...
        <form id="undertakingForm" onsubmit="return false;">
            ...
            <p style="margin-top: 20px;">
                I will be responsible for meeting all academic requirements. I will write internal exams and submit assignments as per the schedule during my visits to the college. I will submit the project synopsis within 15 days of joining. I will forward monthly attendance and progress reports. I agree to produce the internship diary when directed. I agree to submit the final report and certificate upon completion.
            </p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    applicationForm.addEventListener('submit', function(event) {
        ...
        // 2. Stipend Validation (0 or >= 10000)
        const stipendInput = document.querySelector('input[name="stipend"]');
        const stipendValue = parseInt(stipendInput.value, 10);
        if (stipendValue !== 0 && stipendValue < 10000) {
            showError('stipendError', 'Stipend must be 0 (unpaid) or at least ₹10,000.');
        }

        // 3. Duration Validation (6 months or more)
        const durationInput = document.querySelector('input[name="duration"]');
        const durationText = durationInput.value.toLowerCase();
        const durationRegex = /(\d+)\s*(months?|years?)/i;
        ...
        if (match) {
            ...
            if (months < 6) {
                showError('durationError', 'Duration must be 6 months or more.');
            }
        } else {
            showError('durationError', 'Please use a format like "6 months" or "1 year".');
        }
